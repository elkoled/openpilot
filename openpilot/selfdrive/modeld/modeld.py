...
from openpilot.selfdrive.modeld.helpers import usbgpu_present, modeld_pkl_path, get_tg_input_devices, load_oob, load_oob_stream
...
class ModelState:
  ...
  def __init__(self, cam_w: int, cam_h: int, usbgpu: bool):
    ...
    jits = load_oob_stream(modeld_pkl_path(usbgpu)) if usbgpu else load_oob(open_file_chunked(modeld_pkl_path(usbgpu)))
...
def main(demo=False):
  ...
  big_loader = threading.Thread(target=load_big_model, daemon=True) if fallback else None
