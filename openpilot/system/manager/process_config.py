...
def pinball(started: bool, params: Params, CP: car.CarParams) -> bool:
  return params.get_bool("PinballMode")
...
procs = [
  ...
  NativeProcess("stream_encoderd", "openpilot/system/loggerd", ["./encoderd", "--stream"], or_(only_onroad, pinball)),
  PythonProcess("logmessaged", "openpilot.system.logmessaged", always_run),

  NativeProcess("camerad", "openpilot/system/camerad", ["./camerad"], or_(only_onroad, pinball), enabled=not WEBCAM),
  ...
  PythonProcess("webrtcd", "openpilot.system.webrtc.webrtcd", or_(only_onroad, pinball)),
  PythonProcess("pinballd", "openpilot.tools.pinball.pinballd", pinball),
